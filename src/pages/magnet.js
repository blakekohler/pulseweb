...
import * as style from "./magnet.module.scss"
...
const Example = () => {
  return (
    <Layout>
      <SEO title="I want a Pulse magnet" description="Request one of Pulse For Good's awesome magnets." myUrl={'https://www.pulseforgood.com/magnet'} />
      <Container>
