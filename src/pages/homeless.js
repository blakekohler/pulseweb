...
const Example = () => {
  return (
    <Layout>
      <SEO image={wheelchair} title="Pulse for Homeless Service Providers" description="Gather feedback from individuals experiencing homelessness in a way that helps them feel safe to share how they really feel." />
      <Container>
